...
const config = {
    ...
    info: {
        website: 'https://sipalinginformasi.id',
        grupwa: ''
    },
    ...
    session: {
        pairingNumber: '6282362181059',   // Nomor WA yang akan di-pair
    ...
    sticker: {
        packname: '𝗦𝗜 𝗣𝗔𝗟𝗜𝗡𝗚 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗦𝗜 (𝗦𝗣𝗜)',             // Nama pack sticker
        author: 'Si Paling Informasi\n\n\n\n\n\n\n\n\n\n\nTerima kasih'                     // Author sticker
    },

    saluran: {
        id: '', // ID saluran (contoh: 120363xxx@newsletter)
        name: '𝗦𝗜 𝗣𝗔𝗟𝗜𝗡𝗚 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗦𝗜 (𝗦𝗣𝗜)',       // Nama saluran
        link: 'https://www.instagram.com/sipalinginformasi/'                          // Link saluran
    },
    ...
    messages: {
        ...
        ownerOnly: '*Akses Ditolak!* Fitur ini khusus untuk Owner Layanan Otomatis SPI.',
        ...
        privateOnly: ' *Private Only!* Fitur ini hanya bisa digunakan di chat pribadi Layanan Otomatis SPI.',

        adminOnly: '️ *Admin Only!* Kamu harus jadi Admin grup untuk pakai fitur ini.',
        botAdminOnly: '🤖 *Layanan Bukan Admin!* Jadikan Layanan Otomatis SPI sebagai Admin grup dulu biar bisa kerja.',
        ...
        banned: '🚫 *Kamu Dibanned!* Kamu tidak bisa menggunakan Layanan Otomatis SPI ini karena telah melanggar aturan.',
    ...
    APIkey: {
        ...
        openrouter: {
            'nousresearch/hermes-3-llama-3.1-405b:free': process.env.OPENROUTER_API_KEY || '',
            'nvidia/nemotron-3.5-content-safety:free': process.env.OPENROUTER_API_KEY || '',
            'nvidia/nemotron-3-ultra-550b-a55b:free': process.env.OPENROUTER_API_KEY || '',
            'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free': process.env.OPENROUTER_API_KEY || '',
            'poolside/laguna-xs.2:free': process.env.OPENROUTER_API_KEY || '',
            'poolside/laguna-m.1:free': process.env.OPENROUTER_API_KEY || '',
            'moonshotai/kimi-k2.6:free': process.env.OPENROUTER_API_KEY || '',
            'google/gemma-4-26b-a4b-it:free': process.env.OPENROUTER_API_KEY || '',
            'google/gemma-4-31b-it:free': process.env.OPENROUTER_API_KEY || '',
            'nvidia/nemotron-3-super-120b-a12b:free': process.env.OPENROUTER_API_KEY || '',
            'nvidia/llama-nemotron-embed-vl-1b-v2:free': process.env.OPENROUTER_API_KEY || '',
            'qwen/qwen3-next-80b-a3b-instruct:free': process.env.OPENROUTER_API_KEY || '',
            'openai/gpt-oss-120b:free': process.env.OPENROUTER_API_KEY || '',
            'openai/gpt-oss-20b:free': process.env.OPENROUTER_API_KEY || '',
            'z-ai/glm-4.5-air:free': process.env.OPENROUTER_API_KEY || '',
            'qwen/qwen3-coder:free': process.env.OPENROUTER_API_KEY || '',
            'meta-llama/llama-3.3-70b-instruct:free': process.env.OPENROUTER_API_KEY || '',
            'cohere/north-mini-code:free': process.env.OPENROUTER_API_KEY || ''
        }
    }
}
