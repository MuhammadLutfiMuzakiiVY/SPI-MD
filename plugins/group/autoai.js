...
const pluginConfig = {
    ...
    alias: ['aai'],
    category: 'group',
    description: 'Toggle auto AI response untuk grup/pribadi dengan pilihan text atau voice',
...
async function handler(m) {
    ...
    if (m.isGroup && !m.isAdmin && !m.isOwner) {
    ...
    if (mode === 'off') {
        ...
        db.save()
        return m.reply(`🤖 *ᴀᴜᴛᴏ ᴀɪ ᴅɪɴᴏɴᴀᴋᴛɪғᴋᴀɴ*\n\n> Auto AI untuk chat ini telah dimatikan`)
    }
    ...
    txt += `> ℹ️ Bot respond secara otomatis ke semua pesan di chat ini\n`
