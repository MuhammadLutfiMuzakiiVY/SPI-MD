...
Doakan yang terbaik untuknya ya.`,
  ...
  if (customMsg) {
    return customMsg
      ...
      .replace(/{bot}/gi, config.bot?.name || 'Si Paling Informasi')
    ...
    if (goodbyeType === 2) {
            ...
            buttons: [
              ...
              },
              {
                ...
                buttonParamsJson: JSON.stringify({
                  ...
                  url: config.info?.website || "https://sipalinginformasi.id/",
                }),
              },
            ],
          },
      ...
      await sock.sendMessage(groupJid, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            sourceUrl: config.info?.website || "https://sipalinginformasi.id/",
            mediaUrl: config.info?.website || "https://sipalinginformasi.id/",
            mediaType: 3,
            thumbnailUrl: ppUrl,
            title: `Goodbye ${userName}`,
            body: null,
