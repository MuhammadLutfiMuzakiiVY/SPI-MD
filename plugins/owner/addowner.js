...
import { addJadibotOwner, removeJadibotOwner, getJadibotOwners } from '../../src/lib/spi-jadibot-database.js'
import fs from 'fs'
...
async function extractNumber(m) {
    const { resolveAnyLidToJid, isLid, isLidConverted } = await import('../../src/lib/spi-lid.js')
    let targetNumber = ''
