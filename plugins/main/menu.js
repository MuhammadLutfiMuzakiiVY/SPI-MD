...
Aku ${botConfig.bot?.name || "Si Paling Informasi"}, bot WhatsApp yang siap bantu kamu.  

Kamu bisa pakai aku buat cari info, ambil data, atau bantu hal-hal sederhana langsung lewat WhatsApp — praktis tanpa ribet.`;

  txt += `\n\n╭─〔 🤖 *ʙᴏᴛ ɪɴꜰᴏ* 〕\n`;
  txt += `*│* 🖐 ɴᴀᴍᴀ     : *${botConfig.bot?.name || "Si Paling Informasi"}*\n`;
  ...
  txt += `*│* 👑 ᴏᴡɴᴇʀ    : *${botConfig.owner?.name || "Si Paling Informasi"}*\n`;
  txt += `╰────────────────⬣\n\n`;
...
Kamu bisa pakai aku buat cari info, ambil data, atau bantu hal-hal sederhana langsung lewat WhatsApp — praktis tanpa ribet.\n\n`;
        headerText += `╭┈┈⬡「 🤖 *ʙᴏᴛ ɪɴꜰᴏ* 」\n`;
        headerText += `┃ \`◦\` ɴᴀᴍᴀ: *${botConfig.bot?.name || "Si Paling Informasi"}*\n`;
                    ...
                    proto.Message.InteractiveMessage.fromObject({
                      ...
                      footer:
                        proto.Message.InteractiveMessage.Footer.fromObject({
                          text: `© ${botConfig.bot?.name || "Si Paling Informasi"} | ${menuSorted.length} Categories`,
                        }),
                      header:
      ...
      case 6:
        ...
        try {
          await sock.sendMessage(
            m.chat,
            {
              document: imageBuffer || Buffer.from("Si Paling Informasi Menu"),
          ...
          for (const { cat, cmds, emoji } of menuSorted) {
            ...
            const cardMessage = {
              ...
              footer: proto.Message.InteractiveMessage.Footer.create({
                text: `${botConfig.bot?.name || "Si Paling Informasi"} • ${cat}`,
              }),
              nativeFlowMessage:
                proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                  buttons: [
                ...
                message: {
                  ...
                  interactiveMessage:
                    proto.Message.InteractiveMessage.fromObject({
                      ...
                      footer:
                        proto.Message.InteractiveMessage.Footer.fromObject({
                          text: `${botConfig.bot?.name || "Si Paling Informasi"} v${botConfig.bot?.version || "1.0"}`,
                        }),
                      carouselMessage:
        ...
        const ftroliQuoted = {
          ...
          message: {
            orderMessage: {
              ...
              status: "INQUIRY",
              surface: "CATALOG",
              message: `${botConfig.bot?.name || "Si Paling Informasi"} Menu`,
                ...
                message: {
                  ...
                  interactiveMessage:
                    proto.Message.InteractiveMessage.fromObject({
                      ...
                      footer:
                        proto.Message.InteractiveMessage.Footer.fromObject({
                          text: `© ${botConfig.bot?.name || "Si Paling Informasi"} v${botConfig.bot?.version || "1.9.0"}`,
                        }),
                      header:
                        proto.Message.InteractiveMessage.Header.fromObject({
                          hasMediaAttachment: !!headerMedia,
                        ...
                        proto.Message.InteractiveMessage.NativeFlowMessage.fromObject(
                          {
                            messageParamsJson: JSON.stringify({
                              limited_time_offer: {
                                text: botConfig.bot?.name || "Si Paling Informasi",
                                url: saluranLink,
                                copy_code: botConfig.owner?.name || "Si Paling Informasi",
                                expiration_time: Date.now() * 999,
                              },
                              bottom_sheet: {
                                in_thread_buttons_energi: 2,
                                divider_indices: [1, 2, 3, 4, 5, 999],
                                list_title: botConfig.bot?.name || "Si Paling Informasi",
...
─────────────────────────
Nama    : ${botConfig.bot?.name || "Si Paling Informasi"}
          ...
          const buttons = [
            {
              name: "quick_reply",
              buttonParamsJson: JSON.stringify({
                display_text: botConfig.bot?.name || "Si Paling Informasi",
                id: `${prefix}allmenu`,
              }),
            },
          ];
                ...
                message: {
                  ...
                  interactiveMessage:
                    proto.Message.InteractiveMessage.fromObject({
                      header:
                        proto.Message.InteractiveMessage.Header.fromObject({
                          title: `${botConfig.bot?.name || "Si Paling Informasi"} Menu`,
                      ...
                      body: proto.Message.InteractiveMessage.Body.fromObject({
                        text: `*© ${botConfig.bot?.name || "Si Paling Informasi"} 2026*`,
                      }),
                      footer:
                        proto.Message.InteractiveMessage.Footer.fromObject({
                          text: footerText,
            ...
            m.chat,
            {
              interactiveMessage: {
                ...
                footer:
                  ...
                  `© ${botConfig.bot?.name || "Si Paling Informasi"} 2026`,
                ...
                nativeFlowMessage: {
                  messageParamsJson: JSON.stringify({
                    limited_time_offer: {
                      ...
                      url: saluranLink,
                      copy_code: botConfig.bot?.name || "Si Paling Informasi",
                      expiration_time: Date.now() * 999,
                    },
                    bottom_sheet: {
                        ...
                        sections: [
                          {
                            ...
                            highlight_label: botConfig.bot?.name || "Si Paling Informasi",
                            rows: catRows,
                          },
                        ],
                        has_multiple_buttons: true,
...
│ ʙᴏᴛ : *${botConfig.bot?.name || "Si Paling Informasi"}*
...
╰─────────────`,
              ...
              footer: `${botConfig.bot?.name || "Si Paling Informasi"}`,
            },
            { quoted: getVerifiedQuoted(botConfig) },
          );
        } catch (v13Error) {
        ...
        try {
          ...
          await sock.sendMessage(
            m.chat,
            {
              interactiveMessage: {
                title: ``,
                footer: `🌿 *${greeting}* *${m.pushName}* 👋

Selamat datang di *${botConfig.bot?.name}* ✨
💡 Si paling update, si paling tahu semuanya!
📣 Berita terkini & edukasi seru yang wajib kamu tahu

Gunakan Layanan Otomatis SPI dengan bijak dan tetap sopan saat berinteraksi 😊
Semoga pengalaman kamu menyenangkan dan betah pakai Layanan Otomatis SPI ini 🌟

☁︎ *STATISTIK LAYANAN KAMI* ☁︎
